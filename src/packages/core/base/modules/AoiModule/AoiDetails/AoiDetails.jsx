    ...
    return (
      <Fragment>
        ...
        >
          ...
          >
            {languageJson[selectedLanguage].aoiPage.aoiDetails.cardTitle}
          </Typography>
        </Paper>
        {!areaQueryActive ? (
          ...
          {!isAoiEditActive ? (
            !assignVehicle ? (
              <Grid item>
                <Tooltip
                  TransitionComponent={Zoom}
                  title={'Assign vehicle to this Aoi'}
                  style={{ cursor: 'pointer' }}
                >
        ...
        {assignVehicle && (
          <Grid container spacing={2} style={{ padding: 10 }}>
            ...
            <Grid item xs={12}>
              <Typography color="textSecondary">
                Assign vehicle(s)/ group(s) to this AOI
              </Typography>
            </Grid>
            <Grid item xs={12} md={9}>
              <MultiSelectComboBox
                items={vehicles.concat(groups) || []}
                itemKey="id"
...
export default withLanguage(withStyles(styles)(AoiDetails))
