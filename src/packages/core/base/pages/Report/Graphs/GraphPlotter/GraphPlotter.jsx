...
const GraphPlotter = function({ data, pidList }) {
  return (
    <Grid container spacing={3}>
      ...
      {['vehiclespeed', 'distance'].some(val => pidList.includes(val)) && (
        <ElectricGraph data={data} pidList={pidList} />
      )}
...
`
const pidList = ['vehicleSpeed', 'distance']

export default ({ vehicle, from, to, data }) => (
  ...
  //     return <GraphPlotter data={data} pidList={pidList} />
  //   }}
  // </Query>
  //     )
  //   }}
  // </Query>
  <GraphPlotter data={data} pidList={pidList} />
)
