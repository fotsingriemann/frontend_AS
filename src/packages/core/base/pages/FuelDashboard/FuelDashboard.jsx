...
class FuelDashboard extends Component {
  ...
  getGraphData = async () => {
    ...
    if (fetchedData && fetchedData.data.getVehicleFuelLevel.values) {
      ...
      this.setState(
        { maxTankValue: fetchedData.data.getVehicleFuelLevel.maxTankCapacity },
        () => {
  ...
  getFuelStat = async () => {
    ...
    if (response && response.data.getVehicleFuelStatistics) {
      ...
      this.setState({
        fuelStatData: response.data.getVehicleFuelStatistics,
        fuelVTimeLoading: false,
      })
    }
  }
  ...
  getFuelVsTime = (fetchedData) => {
    ...
    fetchedData.forEach((data, index) => {
      ...
      if (data.smoothFuelLevel > 0) {
        newData.push({
          name: data.timeStamp,
          FUELLEVEL: data.smoothFuelLevel,
        })
      }
      //}
    })
    this.setState(
      ...
      () => console.log('fuelVtime', this.state.fuelVtime)
    )
  }
            ...
            <Grid container justify="space-between" alignItems="center">
              <Grid item>
                <Typography
                  ...
                  gutterBottom
                >
                  {languageJson[selectedLanguage].fuelDashboardPage.pageTitle}
                </Typography>
              </Grid>
            </Grid>
            <Divider />
        ...
        <Grid container spacing={2}>
          ...
          <Grid item xs={2}>
            <DateTimePicker
              ...
              disableFuture
              label={languageJson[selectedLanguage].common.dateFilter.fromDate}
            />
          </Grid>
          <Grid item xs={3}>
            <DateTimePicker
                    ...
                    <Grid item xs={2}>
                      <Grid item align="center">
                        <Paper className={classes.paper}>
                          <Typography variant="h5" className={classes.fuelCons}>
                          ...
                          <Typography variant="body1" gutterBottom>
                            {
                              languageJson[selectedLanguage].fuelDashboardPage
                                .fuelConsumptionLabel
                            }
                          </Typography>
                        </Paper>
                      </Grid>
                      <Grid item align="center" className={classes.gap}>
                        <Paper className={classes.paper}>
                          <Typography variant="h5" className={classes.pil}>
...
export default withApollo(
  withStyles(style)(withSharedSnackbar(withLanguage(FuelDashboard)))
)
