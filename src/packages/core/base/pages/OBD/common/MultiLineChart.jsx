...
function MultiLineChart({ isMultiSecond, data, xLabel, yAxes, xKey }) {
  return (
      ...
      >
        ...
        <Brush
          ...
          tickFormatter={unixTime =>
            getFormattedTime(unixTime, 'D MMM, hh:mm:ss:SSS', isMultiSecond)
          }
        />
        <XAxis
          dataKey={xKey}
        ...
        <Tooltip
          labelFormatter={value =>
            getFormattedTime(value, 'Do MMM YYYY hh:mm:ss:SSS', isMultiSecond)
          }
        />
