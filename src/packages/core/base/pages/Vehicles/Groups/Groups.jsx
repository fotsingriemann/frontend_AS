...
import GroupBulkUpload from './GroupBulkUpload'
...
class EnhancedTableHead extends React.Component {
  ...
  getRowDetails = (selectedLanguage) => {
    ...
    console.log('languageJson', languageJson[selectedLanguage])
    let rows = [
      {
        id: 'groupName',
        numeric: false,
  ...
  render() {
    ...
    console.log('selectedLanguage inside render', selectedLanguage)
  ...
  return (
    ...
    >
      <div className={classes.spacer}>
        {languageJson[selectedLanguage].vehiclesPage.groupsTable.cardTitle}
        <Button
          component={Link}
          ...
          variant="contained"
          style={{ marginLeft: 10 }}
          to="/home/manage-vehicles/groupBulk"
        >
          {
            languageJson[selectedLanguage].vehiclesPage.groupsTable
              .groupBulkUploadButtonTitle
          }
        </Button>
      </div>
...
class Groups extends React.Component {
  ...
  /**
   * @callback
   * @summary Toggles selecting all/none
   */
  ...
  getAllGroups = async () => {
    ...
    if (data) {
      ...
      this.setState({ groupsPresent: false, groupsData: [] })
    }
  }
          ...
          <Table className={classes.table} aria-labelledby="tableTitle">
            ...
            <TableBody>
              {stableSort(this.state.groupsData, getSorting(order, orderBy))
                .filter((n) =>
                  n.groupName.toLowerCase().includes(searchValue.toLowerCase())
                )
...
// export default withStyles(styles)(withRouter(withApollo(Groups)))
const WrappedGroups = withLanguage(withStyles(styles)(Groups))
...
export default () => (
  <Switch>
    <PrivateRoute
      ...
      component={withApollo(withLanguage(withStyles(styles)(Groups)))}
    />
    <PrivateRoute
      exact
      path="/home/manage-vehicles/groupBulk"
      render={(props) => <GroupBulkUpload {...props} />}
    />
  </Switch>
)
